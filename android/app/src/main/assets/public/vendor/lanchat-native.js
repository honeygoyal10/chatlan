(() => {
  ...
  var init_web2 = __esm({
    "node_modules/@capacitor/device/dist/esm/web.js"() {
      init_dist();
      DeviceWeb = class extends WebPlugin {
        async getId() {
          return {
  ...
  var Device = registerPlugin("Device", {
    web: () => Promise.resolve().then(() => (init_web2(), web_exports2)).then((m) => new m.DeviceWeb())
  });
  ...
  // src-native-entry.js
  var BackgroundConnection = registerPlugin("BackgroundConnection");
